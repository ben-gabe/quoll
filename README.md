...
[![CI](https://github.com/ben-gabe/quoll/actions/workflows/ci.yml/badge.svg)](https://github.com/ben-gabe/quoll/actions/workflows/ci.yml)
[![Go](https://img.shields.io/badge/go-1.25-00ADD8?logo=go&logoColor=white)](go.mod)
[![License](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
[![Interactive diagram](https://img.shields.io/badge/docs-interactive_diagram-e8a33d)](https://ben-gabe.github.io/quoll/diagram/)
...
→ **[Interactive architecture diagram](https://ben-gabe.github.io/quoll/diagram/)** — hover any component, run the three live scenarios (write trace, stale read, leader kill).
